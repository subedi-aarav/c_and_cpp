...
void main(){
	int matrix[5][5]={{5,6,2,5,1},{3,2,1,0,1},{5,6,8,9,1},{2,6,8,4,6},{1,3,6,8,0}},kernal[KERNAL_SIZE][KERNAL_SIZE]={{2,3,5},{2,1,0},{2,1,1}},i=0,j=0,strip=1,newI=0,newJ=0,tempI,tempJ,size,
	kernalI=0,kernalJ=0,k;
